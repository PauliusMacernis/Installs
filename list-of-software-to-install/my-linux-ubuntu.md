...
- Install additional software manualy:
	...
	- Composer (PHP dependency manager):
		...
		- `ssudo mv composer.phar /usr/local/bin/composer` to make the composer globally available.
		- `composer --version`
	...
	- TBD: Anbox ( https://anbox.io/ ) - Run Android apps on Linux -- In regards to installing kernel modules, Ubuntu version 22.04 is not supported yet ([no release files in the repo](https://ppa.launchpadcontent.net/morphis/anbox-support/ubuntu/dists/)), so there is no easy enough way to install Anbox on Ubuntu 22.04 at the moment, - 25 of Sept, 2022:
...
- Install AWS ECS CLI: https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ECS_CLI_installation.html
  ...
  - Download https://raw.githubusercontent.com/aws/amazon-ecs-cli/mainline/amazon-ecs-public-key.gpg , e.g. to the `~/Desktop` dir
  - `gpg --import ~/Desktop/amazon-ecs-public-key.gpg`
